...
def run_gsm8k_eval():
    ...
    cmd = [
        ...
        "gsm8k",
        "--model_args",
        f"model={MODEL_PATH},base_url={SERVER_URL}/v1/completions,num_concurrent=64,max_retries=3,tokenized_requests=False,trust_remote_code=True",
        "--output_path",
        str(out_dir),
    ]
...
def plot_results(all_results, gsm8k_acc):
    ...
    for idx, profile in enumerate(PROFILES):
        ...
        p_data.sort(key=lambda x: x["p50_speed_tok_s"])
