...
"""
Standalone benchmark for Mistral 3 on TPU.
...
- Model: /mnt/disks/persist/hf/hub/models--mistralai--Mistral-Large-3-675B-Instruct-2512/snapshots/5bb3d32a0a147594527f38cb136a8390eaa82222
- 2K input sequence length
- .5K output sequence length
- TP size 16
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Benchmark Mistral 3 5 layers last token latency.")
    parser.add_argument(
        "--backend",
        type=str,
        choices=["jax", "torch"],
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        "/mnt/disks/persist/hf/hub/models--mistralai--Mistral-Large-3-675B-Instruct-2512/snapshots/5bb3d32a0a147594527f38cb136a8390eaa82222",
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        "gs://mlperf-exp-europe-w/amandaliang/mistral/separate_profiling/",
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '{"compilation_sizes": [128], "sharding": {"sharding_strategy": {"enable_dp_attention": true}}}',
